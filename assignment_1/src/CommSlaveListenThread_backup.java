...
public class CommSlaveListenThread_backup extends Thread {
    private boolean debug = false;
  
    private Socket socket = null;
    private String receivingcontent = new String();
    private RunningProcessTable rpt;
    private SlaveTable_backup st;
    ...
    public CommSlaveListenThread_backup(Socket socket, RunningProcessTable rpt, SlaveTable_backup st) {
      this.socket = socket;
      this.st = st;
      this.rpt = rpt;
